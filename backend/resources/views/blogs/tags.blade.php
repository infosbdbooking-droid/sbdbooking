    ...
    <div class="container-fluid">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-900 font-medium">Blog Tags</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-xl font-bold text-gray-900">Blog Tags</h1>
                </div>
        ...
        <div id="Modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-white w-full max-w-lg mx-auto p-6 rounded-lg shadow-lg relative">
                ...
                <h2 class="text-lg font-bold mb-4" id="modalTitle">Add Tag</h2>
                <form id="dataForm" action="{{ route('blogTags.store') }}" method="POST">
                    @csrf
                    <div class="mb-4"> 
                    ...
                    <div class="mb-4"> 
                        ...
                        <input type="text" name="slug" id="tag_slug" readonly
    ...
    <script>
        $(document).ready(function () {
                ...
                ajax: {
                    ...
                    error: function (xhr) {
                        ...
                        if (response && response.message) {
                            ...
                            $.toastr.error('Error fetching tags.');
                        }
                    }
                },
                columns: [
            ...
            $('#dataForm').on('submit', function (e) {
                ...
                const url = isEditing ? `{{ url('panel/blog-tags') }}/${editingId}` : $(form).attr('action');
            ...
            $('#table tbody').on('click', '.edit-btn', function () {
                ...
                $.get(`{{ url('panel/blog-tags') }}/${editingId}/edit`, function (data) {
                    $('#tag_name').val(data.tag_name);
                    $('#tag_slug').val(data.slug);
                    $('#modalTitle').text('Edit Tag');
                    $('.addBtn').text('Update Tag');
                    $('#Modal').removeClass('hidden').addClass('flex');
                });
            });
            ...
            $('#table tbody').on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    html: '<p class="text-gray-700 text-sm">Are you sure you want to delete this blog tag?</p>',
                    icon: 'warning',
                    width: 350,
