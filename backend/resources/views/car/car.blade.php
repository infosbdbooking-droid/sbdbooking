...
<div class="container-fluid">
   ...
   <div id="Modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 overflow-y-auto">
      <div role="dialog" aria-modal="true" aria-labelledby="modalTitle" class="bg-white w-full max-w-3xl mx-auto p-6 rounded-lg shadow-lg relative max-h-[90vh] overflow-y-auto">
         ...
         <form id="dataForm" action="{{ route('car.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4 flex space-x-4">
               ...
               <div class="w-1/2">
                  ...
                  <div class="flex items-center space-x-2">
                     ...
                     <div class="flex items-center justify-center w-20 h-11 bg-gray-100 rounded-r overflow-hidden">
                        <img id="iconPreview" src="" class="hidden w-full h-full object-contain" alt="Car photo preview" />
                     </div>
                  </div>
               </div>
            </div>
            <div class="mb-4 flex space-x-4">
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Seats <span class="text-black-500">*</span></label>
                  <input type="number" name="car_seats" id="car_seats" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Number of seats">
               </div>
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">AC Available? <span class="text-black-500">*</span></label>
            ...
            <div class="mb-4 flex space-x-4">
               <div class="w-1/2">
                  ...
                  <input type="number" name="max_passengers" id="max_passengers" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Max passengers">
               </div>
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Max Bags</label>
                  <input type="number" name="max_bags" id="max_bags" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Max bags">
               </div>
            </div>
            <div class="mb-4 flex space-x-4">
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Rating Summary</label>
                  <input type="number" name="rating_summary" id="rating_summary" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Rating summary">
               </div>
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Rating Value</label>
                  <input type="number" name="rating_value" id="rating_value" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Rating value">
               </div>
               <div class="w-1/2">
                  <label class="block text-sm font-medium text-gray-700 mb-1">Rating Count</label>
                  <input type="number" name="rating_count" id="rating_count" class="w-full border border-gray-300 rounded px-3 py-2" placeholder="Rating count">
               </div>
            </div>
            <hr class="my-4">
            <div class="mb-4">
               ...
               <div id="recentReviewsWrap">
                  <div class="review-item border rounded p-3 mb-3 bg-gray-50">
                     <div class="flex space-x-2 mb-2">
                        <input type="text"
                           name="recent_reviews[0][name]"
                           class="w-1/2 border rounded px-2 py-2"
                           placeholder="User name">
                        <input type="number"
                           name="recent_reviews[0][rating]"
                           class="w-1/4 border rounded px-2 py-2"
                           placeholder="Stars (1–5)">
                     </div>
                     <textarea name="recent_reviews[0][comment]"
           ...
           columns: [
               ...
               },
               {
                   ...
                   render: function (data) {
                       return data
                           ? `<img src="{{ asset('storage/app/public/images/car') }}/${data}" width="50" height="50" class="mx-auto" />`
                           : 'No Icon';
                   }
               },
               {
