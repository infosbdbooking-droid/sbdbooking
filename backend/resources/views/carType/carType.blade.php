    ...
    <div class="container-fluid">
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <h1 class="text-xl font-bold text-gray-900">List of Car Type</h1>
                <div class="flex flex-wrap gap-2">
                    <button type="button" id="addModalBtn"
                        ...
                        <i class="fas fa-plus mr-2"></i>Car Type
                    </button>
                </div>
            </div>
        </div>
        ...
        <div id="Modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-white w-full max-w-3xl mx-auto p-6 rounded-lg shadow-lg relative">
                ...
                <form id="dataForm" action="{{ route('carType.store') }}" method="POST">
                    @csrf
                    <div class="mb-4"> 
                      ...
                      <input type="text" name="car_type" id="car_type"
                        placeholder="e.g. Force, Maruti, Amaze..."
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#addModalBtn').on('click', function () {
                $('#Modal h2').text('Add Car Type');
                $('.addBtn').text('Add Car Type');
                $('#dataForm')[0].reset();
                isEditing = false;
                editingId = null;
            ...
            */
                ...
                ajax: {
                    ...
                    error: function (xhr) {
                        ...
                        if (response && response.message) {
                            ...
                            $.toastr.error('Server error occurred while fetching Car types.');
                        }
                    }
                },
                columns: [
            ...
            $('#dataForm').on('submit', function (e) {
                ...
                const url = isEditing ? `carType/${editingId}` : $(form).attr('action');
                ...
                $.ajax({
                    ...
                    complete: function () {
                        $(".addBtn").html(isEditing ? 'Update Car Type' : 'Add Car Type').prop('disabled', false);
                    }
                });
            });
            ...
            $('#table tbody').on('click', '.edit-btn', function () {
                ...
                $.get(`carType/${editingId}/edit`, function (data) {
                    $('#car_type').val(data.car_type);
                    $('#Modal h2').text('Edit Car Type');
                    $('.addBtn').text('Update Car Type');
                    $('#Modal').removeClass('hidden').addClass('flex');
                });
            });
            ...
            $('#table tbody').on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    html: '<p class="text-gray-700 text-sm">Are you sure you want to delete this Car type?</p>',
                    icon: 'warning',
                    width: 350,
